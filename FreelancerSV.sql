...
VALUES            ('USR001', 'admin_sys', 'hash_pass_123', 'admin@freelancer.vn', '0901111111', 'ACTIVE', GETDATE(), 'ADMIN'),
...
VALUES                   ('USR003', N'Đại học Bách Khoa', N'Công nghệ thông tin', 'SV20230001', 3.6);
...
VALUES             ('WAL001', 'USR002', 10000000.00, 2000000.00),
...
VALUES              ('JOB001', 'CUS001', N'Thiết kế giao diện Website bằng Figma', N'Cần thiết kế 5 màn hình ứng dụng web', 2000000.00, DATEADD(day, 7, GETDATE()), N'Đang tuyển', 1);
...
VALUES              ('HD001', 'JOB001', 'USR003', 2000000.00, N'Đang thực hiện', GETDATE(), DATEADD(day, 10, GETDATE()));
...
VALUES              ('DG001', 'HD001', 'USR002', 'USR003', 5, N'Sinh viên làm việc rất nhanh và đúng deadline.', GETDATE());
...
VALUES                ('HS001', 'USR003', N'Hồ sơ năng lực Lập trình & Thiết kế', 'https://youtube.com/demo_portfolio');
...
VALUES                    ('DA001', 'HS001', N'Ứng dụng Quản lý Chi tiêu', N'App Flutter di động quản lý tài chính', N'Fullstack Developer', 'Flutter, Dart, Firebase', 'https://github.com/demo/app', 'https://demo.app', 'https://file.app/spec.pdf');