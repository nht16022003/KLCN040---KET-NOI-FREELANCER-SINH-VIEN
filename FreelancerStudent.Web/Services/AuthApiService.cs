...
namespace FreelancerStudent.Web.Services
{
    ...
    public class AuthApiService : IAuthApiService
    {
        ...
        private AuthResultDto FallbackLocalAuth(string usernameOrEmail, string password)
        {
            ...
            if ((input == "sinhvien_b" || input == "sinhvien_b@student.edu.vn") && (password == "123456" || password == "hash_pass_789"))
            {
                return new AuthResultDto
                {
                    IsSuccess = true,
                    ...
                    Email = "sinhvien_b@student.edu.vn",
            ...
            if ((input == "admin1" || input == "admin@freelancer.vn") && (password == "123456" || password == "hash_pass_123"))
            {
                return new AuthResultDto
                {
                    IsSuccess = true,
